...
let en = {
    ...
    "管理流量与收益，继续增长": "Manage traffic and revenue in one place",
    "创建账户，开始提升收益": "Create an account and start growing revenue",
    "让增长更直接": "Smart traffic. Real growth.",
    "全球流量": "Global reach",
    "收益增长": "Fast payouts",
    "手机号": "Phone",
    "密码": "Password",
    ...
    "完成广告任务后，奖励将自动进入账户": "After completing ad tasks, rewards will be credited to your account automatically",
    "任务图片": "Task image",
    "进行中": "In Progress",
    "已完成": "Completed",
    "全部": "All",
    ...
    "赠送": "bonus",
    "推荐": "RECO",
    "请联系客服进行充值。": "Please contact customer service to make a deposit.",
    ...
    "强大的流量筛选工具和智能设置，精准控制广告成本，锁定高效流量": "Use powerful filtering tools and smart settings to control costs and focus on efficient traffic.",
    "广告与流量安全": "Ad and traffic safety",
    "独家三重安全防护系统，有效防御欺诈与恶意软件": "A proprietary three-level protection system helps defend against fraud and malware.",
    "透明且高比例的结算率": "Transparent, competitive payout rates",
    "优质发布商持续变现，受益于极具竞争力的 CPM 价格": "Premium publishers monetize continuously with highly competitive CPM pricing.",
    "用户友好的广告格式": "User-friendly ad formats",
    "针对移动操作系统优化的高性能广告，持续提供相关广告推送": "High-performing mobile-optimized ads deliver relevant promotions across devices.",
    "尊享支持": "Dedicated support",
    "合作伙伴关怀计划包含专业的多语言支持": "Partner care includes professional multilingual support.",
    "广告主": "Advertiser",
    "发布商": "Publisher",
    "查看资料包，获取更多信息。": "View the media kit for more information.",
    "始于 2013，全面助力您的增长": "Helping you grow since 2013",
    "自 2013 年起，Adsterra 通过领先的广告投放与流量变现方案，持续助力全球广告主与发布商增长收益。这是一个让每一位合作伙伴都能实现清晰且卓越的增长目标的共赢平台。": "Since 2013, Adsterra has helped advertisers and publishers grow revenue through advanced ad buying and traffic monetization solutions. It is a win-win platform built to help every partner reach clear, outstanding growth goals.",
    "多样化的广告格式，契合您的目标": "Diverse ad formats for your goals",
    "简洁且友好的浏览器通知": "Simple, user-friendly browser notifications",
    "观看演示": "Watch demo",
    "立即加入 Adsterra": "Join Adsterra now",
    "为您的营销添加高收益流量来源，或开始从您的网站或社交流量中赚取更多收益。": "Add a high-yield traffic source to your marketing, or start earning more from your website or social traffic.",
    "购买优质流量": "Buy quality traffic",
    "开始流量变现": "Start monetizing traffic",
    "36,000+ 优质发布商持续变现，受益于极具竞争力的 CPM 价格": "36,000+ premium publishers monetize continuously with highly competitive CPM pricing.",
    "针对移动操作系统优化的高性能广告，100%提供相关广告的推送": "High-performing ads optimized for mobile operating systems deliver relevant ad pushes 100% of the time.",
    "独特的 Partner Care Program (合作伙伴关怀计划) 包含专业的多语言支持。": "The unique Partner Care Program includes professional multilingual support.",
    "取代传统流量推送的最先进替代方案": "The most advanced alternative to traditional push traffic",
    "无需用户许可，广告可在所有操作系统和浏览器上运行。": "No user permission is required, and ads can run on all operating systems and browsers.",
    "CPM, Smart CPM, CPA Goal 或者 CPA Pricing": "CPM, Smart CPM, CPA Goal, or CPA Pricing",
    "广告优惠会在新的浏览器标签页中打开。": "Ad offers open in a new browser tab.",
    "每月118亿次广告展示": "11.8 billion ad impressions per month",
    "广告直接投放给高意向受众。": "Ads are delivered directly to high-intent audiences.",
    "用户体验友好的广告可在移动和桌面浏览器上运行。": "User-friendly ads work on mobile and desktop browsers.",
    "非侵入式广告，月均9.9亿次展示。": "Non-intrusive ads with 990 million monthly impressions.",
    "专有创意广告，点击率高达30%。": "Proprietary creative ads with click-through rates up to 30%.",
    "成本": "Cost",
    "总天数": "Total Days",
    "有效期": "Validity Period",
    ...
    "更改": "Change",
    "添加账户": "Add Account",
    "请添加用于提现的账户": "Please add an account for withdrawal.",
    "账户": "Account",
    "请输入钱包账户": "Please enter wallet account",
    "请输入银行账户": "Please enter bank account",
    "请输入CNIC": "Please enter CNIC",
    "请确保提现地址信息与本人信息一致": "Please make sure the withdrawal account information matches your own information.",
    "信息保存后将用于后续提现": "The saved information will be used for future withdrawals.",
    "请添加提现地址": "Please add a withdrawal address",
    "提现金额不能大于余额": "Withdrawal amount cannot exceed balance",
    "您已有提现订单处理中": "You already have a withdrawal order in progress",
    "提现中": "Withdrawing",
