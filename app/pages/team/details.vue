          ...
          <template v-if="members.length > 0">
            <div v-for="(item, index) in members" :key="index" class="member-card">
              ...
              <div class="member-row">
                ...
                <span class="member-value money" translate="no">Rs {{ parseFloat(item.total_deposit_amount )}}</span>
              </div>
              <div class="member-row">
                <span class="member-label">{{ $lang('总提现') }}</span>
                <span class="member-value money" translate="no">Rs {{ parseFloat(item.total_without_amount) }}</span>
              </div>
              <div class="member-row">
