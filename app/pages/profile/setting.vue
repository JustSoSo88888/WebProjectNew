<template>
    <div class="setting-page">
        ...
        <div class="settings-list">
            ...
            <div class="settings-group">
                ...
                <div class="setting-item" @click="navigateTo('/profile/wallet')">
                    <div class="item-info">
                        ...
                        <span class="item-label">{{ $lang('银行卡设置') }}</span>
                    </div>
            ...
            <!-- 安全设置 -->
            <div class="settings-group">
                <div class="group-title">{{ $lang('安全设置') }}</div>
                <div class="setting-item" @click="openPasswordModal('trade')">
                    <div class="item-info">
                        ...
                        <span class="item-label">{{ $lang('修改交易密码') }}</span>
                    </div>
                    <div class="item-action">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M9 18l6-6-6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="setting-item" @click="openPasswordModal('login')">
                    <div class="item-info">
                        ...
                        <span class="item-label">{{ $lang('修改登录密码') }}</span>
                    </div>
                    <div class="item-action">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M9 18l6-6-6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
import { updatePassword, updatePayPassword } from '@/api/system'
...
const savePassword = async (form) => {
    let params = {
        account: userData.value.phone,
        area_code: userData.value.area_code,
