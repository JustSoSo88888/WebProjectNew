<template>
    <div class="profile-page">
                ...
                <Transition :name="slideDirection" mode="out-in">
                    <div :key="activeTimeTab" class="earnings-grid">
                        <div class="earnings-item">
                            ...
                            <div class="earnings-val earnings-val--blue">{{ currencySymbol }}{{ currentEarnings.taskIncome }}</div>
                        </div>
                        <div class="earnings-item">
                            <div class="earnings-label">团队邀请收入</div>
                            <div class="earnings-val earnings-val--purple">{{ currencySymbol }}{{ currentEarnings.inviteIncome }}</div>
                        </div>
                        <div class="earnings-item earnings-item--full">
                            <div class="earnings-label">总收入</div>
                            <div class="earnings-val earnings-val--green">{{ currencySymbol }}{{ currentEarnings.total }}</div>
                        </div>
                    </div>
                </Transition>
            </div>
        ...
        <!-- ⑤ 语言切换弹窗 -->
        <LanguageModal v-model="showLang" v-model:currentLang="currentLang" @change="switchLang"/>
